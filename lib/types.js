 ...
 * @property {VerifyLoopOptions} [verifyLoop] - Post-Phase 2 local verification loop settings
 */

/**
 * @typedef {Object} VerifyLoopOptions
 * @property {boolean} enabled
 * @property {number} maxAttempts
 * @property {number} phaseATimeoutSec
 * @property {number} phaseBTimeoutSec
 * @property {'auto'|number} parallelism
 * @property {string[]} skipGates
 */
 ...
 * @property {boolean} [silent] - Run in silent mode (child stdio ignored)
 * @property {boolean} [debugMode] - Enable debug output
 * @property {string|null} [phase] - Current phase identifier ('phase1', 'phase2', 'evaluate')
 */

/**
 * @typedef {'research'|'solution'|'verify_fix'|'rubber_duck_critique'|'rubber_duck_fix'|'auto_review'|'evaluation'} TaskType
 */
 ...
 * @property {string} id
 * @property {string} sourceWorkflow
 * @property {'A'|'B'} phase
 * @property {string[]} paths
 * @property {VerifyCommand[]} commands
 ...
 * @property {string} guidance
 * @property {string} [generatedDiff]
 */

/**
 * @typedef {Object} VerifyLoopResult
 * @property {boolean} passed
 * @property {boolean} skipped
 * @property {number} attempts
 * @property {VerifyGateResult[]} finalFailures
